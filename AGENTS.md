# AGENTS.md — Linna 工作导航

> 独立于主工作区、技术研发区和短剧区。核心使命：搭建制度化、台账化、合规化、可审计、可风控、可复盘的全自动企业经营体系。主营业务为电商，底层内核为企业治理。
...
- **核心铁律** → `.linna/00_CORE_IRON_RULES.md`
- **业务流程/SOP/平台参数** → `.linna/01_BUSINESS_CONFIG.md`
- **日常运行日志/待办** → `.linna/02_RUNTIME_INDEX_LOG.md`
