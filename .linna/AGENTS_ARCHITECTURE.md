...
- **Nova：** main — 🧑‍💼 总工（深度分析 / 调研 / 方案 / 报告主责，基于本地知识库）+ 总工助理（调度、派工、任务台账、快照维护、资讯汇总）
- **Ellie：** Ellie — 👤 技术工程师（代码实现 / 开发执行 / 测试执行 / 缺陷修复）
- **Drama：** drama — 🎬 短剧多媒体编辑
...
| 日期 | 变更内容 | 定稿人 |
|:----|:--------|:------|
| 2026-07-06 | 初始分发 | Nova |
| 2026-08-08 | 分工校准（韩工定）：Nova=总工（深度分析/调研/方案/报告主责）+总工助理；Ellie=技术工程师（代码/开发/测试/缺陷修复） | Nova |
